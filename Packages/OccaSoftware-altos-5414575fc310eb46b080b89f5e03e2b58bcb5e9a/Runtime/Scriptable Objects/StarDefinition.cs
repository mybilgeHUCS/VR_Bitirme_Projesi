...
namespace OccaSoftware.Altos.Runtime
{
  ...
  public class StarDefinition : ScriptableObject
  {
    ...
    [Tooltip(
      "Altos will automatically assign a color to each star. These colors are based on scientific measurements of visible stars."
    )]
    ...
    public AnimationCurve brightnessCurve = new AnimationCurve(
      new Keyframe[]
      {
        new Keyframe(0, 1f),
    ...
    {
      if (AltosSkyDirector.Instance != null)
      {
        return brightnessCurve.Evaluate(AltosSkyDirector.Instance.daytimeFactor);
      }
